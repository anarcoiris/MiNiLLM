...
def train_bpe_tokenizer(
    ...
    if vocab_size < 1000:
        console.print('[yellow]Advertencia: Vocabulario muy pequeño (<1000). Esto puede causar underfitting.[/]')
    elif vocab_size > 100000:
        console.print('[yellow]Advertencia: Vocabulario muy grande (>100K). Esto aumentará uso de memoria significativamente.[/]')
